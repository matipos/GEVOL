...
{
    [TestClass()]
    public class RealRandomSelectionTests
    {
        [TestMethod()]
        [ExpectedException(typeof(ArgumentException))]
        public void ApplyExceptionTest()
        {
            RealRandomSelection rs = new RealRandomSelection();
        ...
        public void ApplyTest()
        {
            ...
            Assert.AreNotEqual<double>(newChromosome.Alpha[0], newChromosome.Sigma[0], "Chromosome is not mixed. Alpha = Sigma = {0}.", newChromosome.Alpha[0]);
            Assert.AreNotEqual<double>(newChromosome.Alpha[0], newChromosome.Values[0], "Chromosome is not mixed. Alpha = Values = {0}.", newChromosome.Alpha[0]);
            Assert.AreNotEqual<double>(newChromosome.Values[0], newChromosome.Sigma[0], "Chromosome is not mixed. Values = Sigma = {0}.", newChromosome.Values[0]);
        }
    }
}